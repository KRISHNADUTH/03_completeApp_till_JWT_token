...
public class CustomerController {
    ...
    @GetMapping("/user")
    public ResponseEntity<String> getLoggedInCustomerDetails(Authentication authentication) {
        return new ResponseEntity<String>((authentication.toString()), HttpStatus.OK);
    }
}
